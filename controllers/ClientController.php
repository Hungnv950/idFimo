...
class Client_app
{
    public static $Clients = array(
        'domain' => 'http://localhost/client-auth/',
        'client_id' => 'pyxnpc373x4xi',
        'client_secret' => 'ZWF1AeqzNZ9nwOJ_w7NNnZBZkQQTQd7QNnj42ntNsHQ',
//        'auth_url' => 'http://id.projectkit.net/auth/signin',
        'url_return' => 'http://127.0.0.1/idFimo/web/client/respone',
        'scope' =>'openid email profile name fullname',
        'url_userInfo' => 'http://127.0.0.1:8080/c2id/userinfo',
